...
st.set_page_config(page_title="Robo AI SAP Assistant", page_icon="💬", layout="wide")
...
.header-container { text-align: center; margin: .25rem 0 1rem 0; }
.header-title { font-size: 28px; font-weight: 800; margin: 0; line-height: 1.2; color: #0f172a; }
.header-sub   { font-size: 14px; color: #64748b; margin-top: .25rem; line-height: 1.2; }
...
# ---------------------------------------
# Header (centered, brand-style)
# ---------------------------------------
st.markdown("""
<div class="header-container">
  <div class="header-title">🤖 Robo AI SAP Assistant</div>
  <div class="header-sub">Your intelligent SAP address & communication data helper</div>
</div>
""", unsafe_allow_html=True)
